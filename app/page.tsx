...
export default function Home() {
  ...
  return (
    <div className="px-4 py-6 flex gap-6  overflow-x-scroll bg-light-grey">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-sm flex items-center justify-center text-medium-grey font-bold w-[280px] h-screen bg-lines-light hover:cursor-pointer self-center text-xl">
          + New Column
        </div>
      </div>
    </div>
